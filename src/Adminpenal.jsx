...
function Adminpenal() {
    ...
    const handelsubmit = async (e) => {
        e.preventDefault();
        try {
            const respons = await fetch("http://localhost:3000/api/food/addfood", {
                method: "post",
                headers: {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
                ...
                <form action="" className="space-y-4" onSubmit={handelsubmit}>
                    ...
                    <input type="text" placeholder="Rastaurent" name="restaurant" onChange={handlechange} value={food.restaurant} className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400" />
